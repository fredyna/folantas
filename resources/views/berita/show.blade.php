                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('berita.update', $berita->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control {{ $errors->has('judul') ? 'has-error':'' }}" id="judul" name="judul"  value="{{ $berita->judul }}" placeholder="masukan judul berita ..." required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <img src="{{ asset('berkas/berita/' . $berita->thumbnail) }}" alt="Thumbnail" style="width: 300px;" class="mb-4">
                                </div>
                                <div class="col-sm-9 offset-sm-3">
                                    <input type="file" class="form-control {{ $errors->has('thumbnail') ? 'has-error':'' }}" id="thumbnail" name="thumbnail" placeholder="pilih thumbnail berita">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <textarea id="deskripsi" class="form-control {{ $errors->has('deskripsi') ? 'has-error':'' }}" id="deskripsi" name="deskripsi" placeholder="masukan deskripsi berita ..." required>{{ $berita->deskripsi }}</textarea>
