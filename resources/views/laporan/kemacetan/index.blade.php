    ...
    <div class="content-wrapper">
        <nav aria-label="breadcrumb" role="navigation">
            <ol class="breadcrumb bg-light">
                <li class="breadcrumb-item active" aria-current="page">Laporan Kemacetan</li>
            </ol>
        </nav>

        <div class="row mb-4">
            <div class="col-12 text-right">
                <a href="{{ route('lapor-kemacetan.create') }}" class="btn btn-success">Tambah Data</a>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-12 grid-margin">
                <div class="card">
                    <div class="card-body">
                        <h6 class="card-title">Tabel Data Laporan Kemacetan</h6>
                        <hr />
                                    ...
                                    @if (count($laporan) > 0)
                                       ...
                                       @foreach ($laporan as $item)
                                           <tr>
                                               ...
                                               <td class="text-center">
                                                   <a href="{{ route('lapor-kemacetan.show', $item->id) }}" class="p-1" data-toggle="tooltip" data-placement="left" title="Edit">
                                                    ...
                                                    <form id="data-{{ $item->id }}" action="{{ route('lapor-kemacetan.destroy', $item->id) }}" method="post" style="display:none;">
                                                        @csrf
                                                        @method('DELETE')
                                                    </form>
                                               </td>
